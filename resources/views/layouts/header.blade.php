        ...
        <div class="relative inline-block text-left group" id="userProfileDropdownWrapper">
            ...
            <div id="headerUserProfileCard" 
                ...
                <div class="pt-2 border-t border-slate-100">
                    <a href="{{ route('logout') }}" class="w-full flex items-center justify-center space-x-2 px-3 py-2 rounded-xl text-xs font-bold text-rose-600 bg-rose-50 hover:bg-rose-100/80 transition">
