...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-xs">
        ...
        <div class="flex items-center space-x-3">
            <button type="button" onclick="toggleCreatePlantForm()" class="btn-secondary py-2.5 px-4 text-xs font-bold shadow-xs">
                + Register Plant
            </button>
            <button type="button" onclick="toggleCreateClientForm()" class="btn-primary py-2.5 px-5 text-xs font-bold shadow-xs">
                                    ...
                                    @foreach ($c->plants as $p)
                                        ...
                                        <div class="bg-slate-50/70 border border-slate-200 rounded-xl p-4 flex flex-col justify-between shadow-2xs hover:bg-slate-50 transition" id="plant-card-{{ $p->id }}">
                                            <div>
                                                ...
                                                <div class="mt-2.5 pt-2 border-t border-slate-200/60 text-[11px] font-mono">
                                                    @if ($p->gst_number)
                                                        <span class="text-slate-500">Plant GSTIN: <strong class="text-slate-700">{{ $p->gst_number }}</strong></span>
                                                    @elseif ($isDiffState)
                                                    ...
                                                    @else
                                                        <span class="text-slate-400 italic">Plant GSTIN: Same as Main GSTIN</span>
                                                    @endif
                                                </div>
                                            </div>

                                            <!-- Plant Action Buttons -->
                                            <div class="flex items-center justify-end space-x-1.5 pt-3 mt-2 border-t border-slate-100">
                                                <button type="button" 
