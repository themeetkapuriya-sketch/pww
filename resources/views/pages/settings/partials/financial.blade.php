        ...
        <form id="financialForm" action="{{ route('settings.financial') }}" method="POST" class="space-y-6" novalidate onsubmit="return handleFinancialSubmit(event);">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="default_gst_rate" class="w-full bg-slate-50 border border-slate-200 rounded-xl py-2.5 px-3.5 text-sm font-semibold text-slate-800 focus:bg-white focus:border-blue-500 transition">
                ...
                <div>
                    ...
                    <select name="financial_year_start_month" class="w-full bg-slate-50 border border-slate-200 rounded-xl py-2.5 px-3.5 text-sm font-semibold text-slate-800 focus:bg-white focus:border-blue-500 transition">
                ...
                <div>
                    ...
                    <select name="number_format_style" class="w-full bg-slate-50 border border-slate-200 rounded-xl py-2.5 px-3.5 text-sm font-semibold text-slate-800 focus:bg-white focus:border-blue-500 transition">
